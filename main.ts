...
if (operationAns.operation === "CheckBalance")
    {console.log(`Your Account Balance Is: ${myAccountBalance}`)}//TEMPLATE LITERAL
...
if (myAccountBalance >= amountAns.amount)
    ...
    console.log(`your remaining balance is: ${remainingBalance}`);}//TEMPLATE LITERAL
...
console.log("Withdraw succesfully\n")
console.log(`your remaining balance is: ${RemainingBalance}`)}//TEMPLATE LITERALS

else {console.log("Sorry You have insufficient balance")}}}
